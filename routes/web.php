...
Route::get('/', [App\Http\Controllers\Principal::class, 'principal'])->name('pagina-principal');
    ...
    Route::prefix('publico')->group(function() { //grupo de rotas

    Route::get('/contato/{nome}', [App\Http\Controllers\Principal::class, 'contato']);      //passando parametro pra função
...
Route::fallback(function(){ //quando a rota que procuramos não existe
